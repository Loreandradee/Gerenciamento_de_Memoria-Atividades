...
| **TODOS** |  | **Questão 6:** (Questão bônus) Implementação de Algoritmo LRU  | **Python** |
...
| `Respostas_Teoricas - SO.pdf` ou `.md` | Documento com as respostas da Parte A das Questões 1 a 5 - Enviado por email. | Todos Realizaram. Enviado por Lorena |
...
| `Questão06_bonus_lru/` | Código **Python** da Questão Bônus. | Todos |
